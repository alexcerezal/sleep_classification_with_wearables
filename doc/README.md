...
The complete academic and technical documentation is available in [main.pdf](main.pdf). This README provides only a functional overview of the principal source files.
...
For the project motivation, methodology, dataset details, experimental design, results, and full discussion, see [the complete project report](main.pdf).
